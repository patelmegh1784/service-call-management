...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>register now</h3>
      <input type="text" name="name" required placeholder="enter your username" minlength="3" maxlength="20"  class="box">
...
<i style="font-size:24px; float: right;
  ...
  z-index: 2;" class="fa" onclick="Toggle()">&#xf06e;</i>
      ...
      <input type="password" name="cpass" required placeholder="confirm your password" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="typepass1" >
